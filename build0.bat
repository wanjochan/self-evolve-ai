...
%TCC% -o bin\tool_astc2rt.exe src\tools\tool_astc2rt.c src\tools\astc2rt.c src\tools\c2astc.c -Isrc\runtime -Isrc\tools

echo Building evolver0_loader...
%TCC% -o bin\evolver0_loader.exe src\evolver0\evolver0_loader.c src\runtime\platform_minimal.c -Isrc\runtime
